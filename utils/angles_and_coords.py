...
def extract_backbone_seqs(
    ...
    # chain = [c.chain_id for c in ca if c.atom_name in atoms]
    return amino_acids#, chain
...
if __name__ == "__main__":
    ...
    print( 
        extract_backbone_seqs("/gaozhangyang/experiments/ProreinBinder/data/cath/dompdb/1a0aA00")
    )