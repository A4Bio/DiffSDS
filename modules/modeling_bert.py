    ...
    def forward(
        ...
        if self.position_embedding_type == "relative_key" or self.position_embedding_type == "relative_key_query":
            ...
            if self.position_embedding_type == "relative_key":
                ...
                attention_weights = attention_weights + relative_position_scores_query + relative_position_scores_key
        ...
        outputs = (context_layer, attention_weights, attention_probs) if output_attentions else (context_layer,)
